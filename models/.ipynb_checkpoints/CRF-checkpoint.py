...
class CRF_v3(MyModel_v3):
    ...
    def __init__(self, config):
        ...
        self.state_matrix = nn.Parameter(torch.randn(self.Candidate_num, self.Candidate_num))
    ...
    def cal_crf_score(self, indicex_K, item_embeds): #[batch, intere_num] [batch, num, embed_dim] 
        ...
        Candidate_sim_score = torch.einsum('ijd, kd -> ijk', item_embeds, self.Candidate_pool) #[batch,num,Candidate_num]
        # 对每个batch内的得分，降序排列
